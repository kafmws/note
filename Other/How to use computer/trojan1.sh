...
systemctl stop nginx
        ...
        real_addr6=`nslookup tj.kafm.xyz | grep "Addr" | tail -n 1 | cut -c10-`
        local_addr6=`curl ipv6.icanhazip.com`
        green " "
        green " "
        green "==================================="
         blue "检测到域名解析地址为 $real_addr $real_addr6"
         blue "本VPS的IP为 $local_addr $local_addr6"
        green "==================================="
        sleep 3s
if [ $real_addr == $local_addr ] || [ $real_addr6 == $local_addr6 ] ; then
        green " "
        green " "
        green "=========================================="
        blue "        开始安装Nginx并配置"
